# =====================================================================
# Figure A03 — Persistence scatterplots restricted to household heads
# Produces:  output/Figure A03.pdf
#            (also saves results_educ_hh_heads.rds and
#             results_ocup_hh_heads.rds with the bootstrap results)
# Inputs:    data_2002_2011_unique_genderless.csv,
#            data_1992_2011_unique_genderless.csv (linked samples),
#            LIMBA92.DBF (1992 language codes)
# Summary:   Same persistence-by-education and persistence-by-occupation
#            analysis as Figure 01, but restricted to household heads
#            (GRUD==1 in both census waves) and adjusted for spurious
#            cross-sex links. Confidence bands come from a town-level
#            bootstrap (iter resamples, re-seeded each iteration). Left
#            panel = education, right panel = occupation.
# =====================================================================

# ---- Load the genderless linked samples ----
#load data----
