# =====================================================================
# Figure 01 (+ Appendix Figures A04, A05, A06) — Ethnic persistence by education and occupation
# Produces:  output/Figure 01.pdf, Figure A04.pdf, Figure A05.pdf, Figure A06.pdf
# Inputs:    data_1992_2011_unique_genderless.csv, data_2002_2011_unique_genderless.csv
#            (linked census panels), LIMBA92.DBF (1992 native-language lookup)
# Summary:   For each education level (and, separately, occupation), computes the
#            share of baseline-identified Roma/Hungarian/Other who still report the
#            same ethnicity in 2011 ("persistence"). The raw persistence rate is
#            corrected for gender-mismatched (likely false) census links via the
#            p_real formula, and 90% bands come from a town-level bootstrap (iter=200).
#            Figure 01 = main text (1992-2011); A05 = 2002-2011; A04/A06 = "Other" group.
# =====================================================================
